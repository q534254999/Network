...
//	this.text = new cjs.Text("Table", "bold 10px Arial", "#393536");
 	this.text = new DOMObject({type:"TEXT", subType:"TABLE", compId:"ID_table",  width:"448", x:"-130",y:"-10"}); 
...
(lib.packet4 = function() {
	...
	this.text_1.setTransform(-28,18);
...
(lib.packet3 = function() {
	...
	this.text_2.setTransform(41,18);
...
(lib.packet2 = function() {
	...
	this.text_3.setTransform(42,18);
...
(lib.packet = function() {
	...
	this.text_4.setTransform(-24,18);
