...
(lib.table2 = function() {
	...
	// ID_txt06
	this.text_5 = new DOMObject({type:"TEXT",compId:"ID_txt06",width:"100",expand:"up+down",align:"left",color:"#FFFFFF",size:"9"});
	...
	// ID_txt05
	this.text_6 = new DOMObject({type:"TEXT",compId:"ID_txt05",width:"100",expand:"up+down",align:"left",color:"#FFFFFF",size:"9"});
	...
	// ID_txt03
	this.text_7 = new DOMObject({type:"TEXT",compId:"ID_txt03",width:"113",expand:"up+down",align:"left",color:"#FFFFFF",size:"9"});
	
	this.text_7.setTransform(110,67);

	// ID_txt02
	this.text_8 = new DOMObject({type:"TEXT",compId:"ID_txt02",width:"113",expand:"up+down",align:"left",color:"#FFFFFF",size:"9"});
	this.text_8.setTransform(-3,67);

	// ID_txt04
	this.text_9 = new DOMObject({type:"TEXT",compId:"ID_txt04",width:"200",expand:"right",align:"left"});
	this.text_9.setTransform(6,41);
