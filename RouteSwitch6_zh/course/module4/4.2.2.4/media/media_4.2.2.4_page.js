...
(DrawActivity = function(container,id,manifest,answerArr,lineObjArr){
	...
	btn1 = getCJSElement("BLUE_BUTTON",{x:172.8,y:368.85,width:125,height:21,div:"slide_"+id,compId:"ID_check"+id,id:"check",callback:checkBtnHandler,enabled:"true"});
	container.addChild(btn1);
	
	//alert(btn1.enabled);
	
	btn2 = getCJSElement("BLUE_BUTTON",{x:300.25,y:368.85,width:145,height:21,div:"slide_"+id,compId:"ID_undo"+id,id:"undo",callback:undoHandler,enabled:"true"});
	container.addChild(btn2);
	
	btn3 = getCJSElement("BLUE_BUTTON",{x:447.7,y:368.85,width:145,height:21,div:"slide_"+id,compId:"ID_reset"+id,id:"reset",callback:resetHandler,enabled:"true"});
	container.addChild(btn3);
	
	answerBtn = getCJSElement("BLUE_BUTTON",{x:595.15,y:368.85,width:145,height:21,div:"slide_"+id,compId:"ID_answer"+id,id:"answer",callback:answerHandler,enabled:"true"});
	container.addChild(answerBtn);
	
	hideBtn = getCJSElement("BLUE_BUTTON",{x:595.15,y:368.85,width:145,height:21,div:"slide_"+id,compId:"ID_hide"+id,id:"hide",callback:answerHandler,enabled:"true"});
	hideBtn.visible=false;
	container.addChild(hideBtn);
	
	
	ansPopupWindow = getCJSElement("TEXTBOX",{x:65.15,y:108.85,width:200,height:165,subType:"CLOSABLE",titleId:"ID_s"+id+"_InCorrectTitle",bodyId:"ID_s"+id+"_InCorrectText",visible:"0"});
