...
(RootContainer = function(){
	...
	{			
		...
		if(window.parent.pageSize == "470*400"){
			ratio = 1.17;	
		    th.scaleX = th.scaleY = ratio;
		    if(sWidth*ratio > canvas.width)	{
		    	th.x = (((sWidth * ratio) - (canvas.width ))/2);
		    	th.y = 0;
		    }
		    mediaStage.update();
		}				
...
(BubbleComp = function (obj) {
	...
	shadowShape.graphics.beginFill("#000").drawRoundRect(0,0,obj.wid-5,height-2,4);	
