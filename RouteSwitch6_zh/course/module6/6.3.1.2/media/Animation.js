...
(lib.envelopeclosedstatic = function() {
	...
	this.instance_2.setTransform(-27,-26.1,0.595,0.595);
...
(lib.frame03 = function() {
	...
	this.text.setTransform(27,3);
//this.text.setTransform(24,0);
	// Layer 1
	this.instance_5 = new lib.envelopeclosedstatic();
	this.instance_5.setTransform(46.5,8.7,0.913,0.913,0,0,0,1.6,0.1);
...
(lib.frame02 = function() {
	...
	this.text_1.setTransform(35,3);

	// Layer 1
	this.instance_6 = new lib.envelopeclosedstatic();
	this.instance_6.setTransform(54.2,8.9,0.913,0.913,0,0,0,1.6,0);
...
(lib.frame01 = function() {
	...
	this.text_2.setTransform(-129,-13.3);

	// Layer 1
	this.instance_7 = new lib.envelopeclosedstatic();
	this.instance_7.setTransform(-113.7,-11.6,0.913,0.913,0,0,0,1.3,0.3);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{},true);
	...
	this.text_17.setTransform(52,148.6);
