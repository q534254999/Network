...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{},true);
	...
	this.instance_1.setTransform(21.8,285.7,0.41,0.41,0,0,0,1.5,0.1);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(14).to({alpha:1},5,cjs.Ease.get(1)).to({x:159.8,y:285.9},34).to({alpha:0},7).to({y:285.7,alpha:1},7).to({y:285.9,alpha:0},7).to({alpha:1},7).wait(15).to({x:218.6,y:178.1},28).wait(1).to({alpha:0},7).to({alpha:1},7).to({alpha:0},7).to({alpha:1},7).wait(15).to({x:282.6,y:285.9},29).wait(15).to({alpha:0},7).to({alpha:1},7).to({alpha:0},7).to({alpha:1},7).to({x:415},29).to({alpha:0},7).wait(2));
	...
	this.text_9.setTransform(122,269.7);

	this.text_10 = new DOMObject({type:"TEXT",text:"S0/0/1"});
	this.text_10.setTransform(235,270);

	this.text_11 = new DOMObject({type:"TEXT",text:"S0/0/0"});
	this.text_11.setTransform(173,186.2);
	...
	this.text_13.setTransform(195,151.5);
