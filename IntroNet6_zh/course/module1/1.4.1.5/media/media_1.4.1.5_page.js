...
(slideViewDidLoad = function(_container, _id) {
    btnXPosArr = [203.45, 68.6, 338.25, 317.25, 204.45, 82.6, 171.5];
    btnYPosArr = [114.75, 195.85, 197.6, 320.1, 403.3, 322.85, 251.2];
    buttonArr = [];
    buttonClickArr = [];
    buttonOverArr = [];
    bubbleArr = [];
    ...
    for (var i = 0; i < 7; i++) {
        ...
        btn4 = getCJSElement("IMAGE", { x: btnXPosArr[i] + 5, y: btnYPosArr[i] + 2.4, width: 35, height: 35, src: "../../../common/images/plus_btn_over2.png", });
        ...
        var btn2 = getCJSElement("TEXTBOX", { x: 452, y: 77, width: 212.85, height: 340, size: 11, titleId: bubbleTitleArr[i], bodyId: bubbleTextArr[i], });
