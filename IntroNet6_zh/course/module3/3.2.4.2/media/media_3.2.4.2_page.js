...
{
btnXPosArr=[264,264,264,264,264,264,264];
btnYPosArr=[100.45,145.55,190.65,235.75,280.85,325.95,371.05];
buttonArr=[];
buttonClickArr=[];
buttonOverArr=[];
bubbleArr=[];
sampleArray=[];
var lastBtnClick;
bubbleTitleArr=["ID_s1_titleTxt07","ID_s1_titleTxt06","ID_s1_titleTxt05","ID_s1_titleTxt04","ID_s1_titleTxt03","ID_s1_titleTxt02","ID_s1_titleTxt01"]
bubbleTextArr=["ID_s1_bodyTxt07","ID_s1_bodyTxt06","ID_s1_bodyTxt05","ID_s1_bodyTxt04","ID_s1_bodyTxt03","ID_s1_bodyTxt02","ID_s1_bodyTxt01"]
for(var i=0;i<7;i++)
{
...
var btn2 = getCJSElement("TEXTBOX",{x:377,y:115,width:240,height:275,size:11,titleId:bubbleTitleArr[i],bodyId:bubbleTextArr[i]});
