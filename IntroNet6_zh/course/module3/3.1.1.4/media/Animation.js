...
(lib.ID_john = function() {
	...
	// ID-john
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_john", width:"50",  size:"10", expand:"down",color:"#FFFFFF"}); 
...
(lib.ID_jane = function() {
	...
	// ID_bodyText
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_jane", width:"57",  size:"10", expand:"down",color:"#FFFFFF"});	
...
(lib.ID_dear = function() {
	...
	// ID_dear
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_dear", width:"57",  size:"10", expand:"down",color:"#FFFFFF"});	
...
(lib.ID_box9 = function() {
	...
	// ID_box9
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_box9", width:"300.6",  size:"10", expand:"down",color:"#FFFFFF"});	
...
(lib.ID_box8 = function() {
	...
	// ID_box8
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_box8", width:"110.45",  size:"10", expand:"down",color:"#FFFFFF"});	
...
(lib.ID_box7 = function() {
	...
	// ID_box7
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_box7", width:"48.15",  size:"9", expand:"down",color:"#FFFFFF"});	
...
(lib.ID_box6 = function() {
	...
	// ID_box6
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_box6", width:"58",  size:"9", expand:"down",color:"#FFFFFF"});	
...
(lib.ID_box5 = function() {
	...
	// ID_box5
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_box5", width:"71.05",  size:"10", expand:"down",color:"#FFFFFF"});	
...
(lib.ID_box4 = function() {
	...
	// ID_box4
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_box4", width:"50",  size:"9", expand:"down",color:"#FFFFFF"});	
...
(lib.ID_box3 = function() {
	...
	// ID_box3
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_box3", width:"50",  size:"9", expand:"down",color:"#FFFFFF"});	
...
(lib.ID_box2 = function() {
	...
	// ID_box2
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_box2", width:"50",  size:"9", expand:"down",color:"#FFFFFF"});	
...
(lib.ID_box1 = function() {
	...
	// ID_box1
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_box1", width:"50",  size:"9", expand:"down",color:"#FFFFFF"});	
...
(lib.ID_bodyText = function() {
	...
	// ID_bodyText
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_bodyText", width:"66.9",  size:"10", expand:"down",color:"#FFFFFF"});	
...
(lib.ID_address2 = function() {
	...
	// ID_address2
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_address2", width:"57",  size:"10", expand:"down",color:"#FFFFFF"});	
...
(lib.ID_address1 = function() {
	...
	// ID_address1
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_address1", width:"57",  size:"10", expand:"down",color:"#FFFFFF"});	
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.setTransform(282.3,95.1,1,1,0,0,0,21.8,9.3);
	...
	this.instance_21.setTransform(349.9,160.4,1,1,0,0,0,24.6,32);
	...
	this.instance_22.setTransform(415.8,160.4,1,1,0,0,0,30,32);
	...
	this.instance_23.setTransform(63.6,222,1,1,0,0,0,55.2,6.5);
	...
	this.instance_24.setTransform(283,222,1,1,0,0,0,150.3,6.5);
...
p.nominalBounds = new cjs.Rectangle(5,22.3,530,329.8);
...
(lib.slide_1 = function() {
	...
	this.anim01.setTransform(435.6,306.1,1,1,0,0,0,327.6,246.1);
