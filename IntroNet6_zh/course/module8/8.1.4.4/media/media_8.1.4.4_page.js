...
var textBox	= getCJSElement("TEXTBOX",{subType:"CLOSABLE",x:"538.15",y:"320.1",width:"260",height:"120",titleId:"txt_incorrect",bodyId:"txt_body_incorrect",animated:"0",visible:"0"});
		_container.addChild(textBox);

btn = getCJSElement("BLUE_BUTTON",{x:478.8,y:283.55,width:108,height:21,size:12,id:"check",compId:"txt_check",callback:btnCheckClicked});
		_container.addChild(btn);
		
		btn = getCJSElement("BLUE_BUTTON",{x:609.6,y:283.55,width:108,height:21,size:12,id:"reset",compId:"txt_reset",callback:btnResetClicked});
		_container.addChild(btn);
		
		btn = getCJSElement("BLUE_BUTTON",{x:740.45,y:283.55,width:108,height:21,size:12,id:"newnumber",compId:"txt_newnumber",
...
for(var i=0; i<4 ;i++){
		...
		bitIn.style.cssText = "position:absolute;width:76px;background-color:#FDEED0;color:#000000; border:0px solid #FDEED0";
