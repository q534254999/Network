...
p.nominalBounds = new cjs.Rectangle(0,0,338,141);


(lib.Bitmap3 = function() {
	this.initialize(img.Bitmap3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,392,195);
...
(lib.Symbol1 = function() {
	...
	// Layer 1
	this.text = new BubbleComp({x:"0",y:"0",width:"255",compId:"ID_txt05",align:"left",tailPosition:"7",tailFlip:"2",extend:"right"});
	//this.text = new cjs.Text("TextBox, W:275, h:40, A:L, ID:ID_txt05, TF:0, TP:7", "17px 'Arial'", "#393536");
	this.text.lineHeight = 19;
	this.text.lineWidth = 284;
	this.text.setTransform(4,-50);
...
(lib.Animation = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(455,253,1,1,0,0,0,144,22);
	this.instance.alpha = 0;

	this.instance_1 = new lib.Symbol1copy2();
	this.instance_1.setTransform(153,253,1,1,0,0,0,144,22);
	this.instance_1.alpha = 0;

	this.instance_2 = new lib.Symbol1copy();
	this.instance_2.setTransform(481,109,1,1,0,0,0,144,22);
	...
	this.instance_3.setTransform(189,109,1,1,0,0,0,144,22);
	this.instance_3.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(306).to({alpha:1},0).wait(65));

	// bubbles3
	this.instance_4 = new lib.Symbol1();
	this.instance_4.setTransform(191.5,109,1,1,0,0,0,144,22);
	...
	this.instance_5.setTransform(461,253,1,1,0,0,0,144,22);
	...
	this.instance_6.setTransform(41.9,120.5);
	...
	this.instance_10.setTransform(67,145.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(371));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(9,87,566,228.5);
...
p.nominalBounds = new cjs.Rectangle(101.3,104.1,566,228.5);
...
p.nominalBounds = new cjs.Rectangle(441.3,349.1,566,228.5);
