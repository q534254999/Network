...
(slideViewDidLoad = function (_container, _id) {
    if (_id == 1) {
        var temp = '<div id="wrapper"><div id="slidetitile">></div><div id="flowbg"><img width="440" height="30" src="flowbg.png"></div><div id="imageflow"></div><div id="year"></div><div id="standard"></div><div id="description"></div><div id="tablediv" ><table cellspacing="0" cellpadding="0"><tr><td><span id="year1" class="row1"></span></td><td><span id="year2" class="row1"></span></td><td><span id="year3" class="row1"></span></td><td><span id="year4" class="row1"></span></td><td><span id="year5" class="row1"></span></td><td><span id="year6" class="row1"></span></td><td><span id="year7" class="row1"></span></td><td><span id="year8" class="row1"></span></td><td><span id="year9" class="row1"></span></td><td><span id="year10" class="row1"></span></td><td><span id="year11" class="row1"></span></td><td><span id="year12" class="row1"></span></td><td><span id="year13" class="row1"></span></td><td><span id="year14" class="row1"></span></td></tr><tr><td><span id="C1R1" class="row2"></span></td><td><span id="C1R2" class="row2"></span></td><td><span id="C1R3" class="row2"></span></td><td><span id="C1R4" class="row2"></span></td><td><span id="C1R5" class="row2"></span></td><td><span id="C1R6" class="row2"></span></td><td><span id="C1R7" class="row2"></span></td><td><span id="C1R8" class="row2"></span></td><td><span id="C1R9" class="row2"></span></td><td><span id="C1R10" class="row2"></span></td><td><span id="C1R11" class="row2"></span></td><td><span id="C1R23" class="row2"></span></td><td><span id="C1R25" class="row2"></span></td><td><span id="C1R27" class="row2"></span></td></tr><tr><td><span id="C1R12" class="row3"></span></td><td><span id="C1R13" class="row3"></span></td><td><span id="C1R14" class="row3"></span></td><td><span id="C1R15" class="row3"></span></td><td><span id="C1R16" class="row3"></span></td><td><span id="C1R17" class="row3"></span></td><td><span id="C1R18" class="row3"></span></td><td><span id="C1R19" class="row3"></span></td><td><span id="C1R20" class="row3"></span></td><td><span id="C1R21" class="row3"></span></td><td><span id="C1R22" class="row3"></span></td><td><span id="C1R24" class="row3"></span></td><td><span id="C1R26" class="row3"></span></td><td><span id="C1R28" class="row3"></span></td></tr></table></div><div id="slidebar"><div id="pointer"></div></div><div id="yeardiv"><span><b>1973 &nbsp; 1980 &nbsp; 1983 &nbsp; 1985&nbsp; 1990&nbsp; 1993&nbsp; 1995&nbsp; 1998&nbsp; 1999&nbsp; 2002&nbsp; 2006&nbsp; 2009&nbsp; 2015&nbsp; 2016</b></span></div><div id="wrapper1"><div id="div1"></div></div><div id="ID_instruction"></div></div>';
        var dom;
        ...
        $("#year12").html(getMediaText("yr12"))
        $("#year13").html(getMediaText("yr13"))
        $("#year14").html(getMediaText("yr14"))
        ...
        $("#C1R23").html(getMediaText("ID_C1R23"))
        $("#C1R24").html(getMediaText("ID_C1R24"))
        $("#C1R25").html(getMediaText("ID_C1R25"))
        $("#C1R26").html(getMediaText("ID_C1R26"))
        $("#C1R27").html(getMediaText("ID_C1R27"))
        $("#C1R28").html(getMediaText("ID_C1R28"))
        ...
        function DisplayCurrentScroll() {
            ...
            var pointer_left = 510 * scroll_percentage / 100;
