...
{
btnXPosArr=[215,45,45,215];
btnYPosArr=[58,207,266,405];
buttonArr=[];
buttonClickArr=[];
buttonOverArr=[];
bubbleArr=[];
...
var btn2 = getCJSElement("TEXTBOX",{x:389,y:140,width:240,height:180,size:11,titleId:bubbleTitleArr[i],bodyId:bubbleTextArr[i]});
