...
{
    btnXPosArr=[224.85,220,450,469,520,547];
btnYPosArr=[26,258,258,26,26,258];
buttonArr=[];
buttonClickArr=[];
buttonOverArr=[];
bubbleArr=[];
...
var btn2 = getCJSElement("TEXTBOX",{x:65,y:317.45,width:540,height:150,size:11,titleId:bubbleTitleArr[i],bodyId:bubbleTextArr[i]});
