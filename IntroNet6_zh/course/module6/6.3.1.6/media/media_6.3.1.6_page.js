...
var sampleArray=[];
var lastBtnClick;
var bubbleTitleArr=["ID_s1_titleTxt01","ID_s1_titleTxt02"]
var bubbleTextArr=["ID_s1_bodyTxt01","ID_s1_bodyTxt02"]
for(var i=0;i<2;i++)
{
...
var btn2 = getCJSElement("TEXTBOX",{x:70,y:321.3,width:541,height:146,size:11,titleId:bubbleTitleArr[i],bodyId:bubbleTextArr[i]});
...
var btnXPosArr=[380,523];
var btnYPosArr=[255,255];
var buttonArr=[];
var buttonClickArr=[];
var buttonOverArr=[];
var bubbleArr=[];
var sampleArray=[];
var lastBtnClick;
var bubbleTitleArr=["ID_s2_titleTxt01","ID_s2_titleTxt02"]
var bubbleTextArr=["ID_s2_bodyTxt01","ID_s2_bodyTxt02"]
