...
(slideViewDidLoad = function(_container,_id)
{
	...
	function binToDeci(arg)
	{
		...
		feeback = getCJSElement("TEXTBOX",{subType:"CLOSABLE",x:507.15,y:350.1,width:368,height:117,titleId:"ID_INCORRECT_TITLE",bodyId:"ID_INCORRECT_BODY",visible:"0"});			  
	...
	generaterandom(256);
	//alert(mediaStage);
	btn = getCJSElement("BLUE_BUTTON",{x:504.05,y:288.55,width:108,height:21,size:12,compId:"ID_btn01",callback:checkBit});
	_container.addChild(btn);
	
	btn = getCJSElement("BLUE_BUTTON",{x:631,y:288.55,width:108,height:21,size:12,compId:"ID_btn02",callback:resetBit});
	_container.addChild(btn);
	
	btn = getCJSElement("BLUE_BUTTON",{x:759,y:288.55,width:108,height:21,size:12,compId:"ID_btn03",callback:newBit});
	_container.addChild(btn);
