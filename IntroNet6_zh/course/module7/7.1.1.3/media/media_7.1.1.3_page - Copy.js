...
(slideViewDidLoad = function(_container,_id)
{
  ...
  btnYPosArr=[84.15,137.2,190.25,243.3];
buttonArr=[];
buttonClickArr=[];
buttonOverArr=[];
bubbleArr=[];
...
var btn2 = getCJSElement("TEXTBOX",{x:40,y:315,width:600,height:140,size:11,titleId:bubbleTitleArr[i],bodyId:bubbleTextArr[i],});
