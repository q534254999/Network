...
(slideViewDidLoad = function(_container, _id) {
	if(_id == 1){
		...
		for(var i=0;i<4;i++) {
			...
			var btn2 = getCJSElement("TEXTBOX",{x:40,y:365,width:600,height:120,size:11,titleId:bubbleTitleArr[i],bodyId:bubbleTextArr[i]});
	...
	if(_id == 3){
		...
		for(var i=0;i<4;i++) {
			...
			var btn2 = getCJSElement("TEXTBOX",{x:40,y:365,width:600,height:120,size:11,titleId:bubbleTitleArr3[i],bodyId:bubbleTextArr3[i]});
			if(i != 0) btn2.visible = false;
