...
(slideViewDidLoad = function(_container,_id){
	...
	var btn = getCJSElement("BLUE_BUTTON",{x:425.45,y:289.4,width:130,height:21,size:12,id:"check",compId:"txt_check",
	callback:btnCheckClicked});
	_container.addChild(btn);
	

	btn = getCJSElement("BLUE_BUTTON",{x:590.25,y:289.4,width:130,height:21,size:12,id:"reset",compId:"txt_reset",callback:
	btnResetClicked});
	_container.addChild(btn);
	
	btn = getCJSElement("BLUE_BUTTON",{x:751.65,y:289.4,width:130,height:21,size:12,id:"newnumber",compId:"txt_newnumber",
	callback:btnNewNumberClicked});
	_container.addChild(btn); 
  

	var textBox	= getCJSElement("TEXTBOX",{subType:"CLOSABLE",x:"449.65",y:"350",width:"350",height:"118",titleId:
