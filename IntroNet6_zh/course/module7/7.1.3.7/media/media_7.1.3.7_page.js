...
(slideViewDidLoad = function(_container,_id)
{
		//CREATE PC IMAGES		
		var pcImgArray = [
				{id:"host6", x:"535.45", y:"113.55"},
				{id:"host5", x:"677.75", y:"148.4"},
				{id:"host4", x:"677.75", y:"281"},
				{id:"host3", x:"535.45", y:"325.7"},
				{id:"host2", x:"394.95", y:"291"},
				{id:"host1", x:"394.95", y:"148.4"}
		];
		...
		var startbtn;
		var resetbtn;	
		stopbtn = getCJSElement("BLUE_BUTTON",{x:386.8,y:444.1,width:167,height:21,size:12, id:"stopBtn",compId:"ID_stop", callback:buttonHandler});			
		startbtn = getCJSElement("BLUE_BUTTON",{x:386.8,y:444.1,width:167,height:21,size:12,id:"startBtn",compId:"ID_start", callback:buttonHandler});			
		resetbtn = getCJSElement("BLUE_BUTTON",{x:586.05,y:444.1,width:167,height:21,size:12,id:"resetBtn",compId:"ID_reset", callback:buttonHandler});
		...
		var textBox = getCJSElement("TEXTBOX",{x:461.05,y:167.2,width:220,height:160, bodyId:"ID_cBroad", visible:"0", animate:"0" });
